            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="id_pasien" id="id_pasien">
                    ...
                    <?php foreach($pasiens as $pasien): ?>
                        ...
                        <?php if($kunjungan['id_pasien'] == $pasien['id']) echo 'selected' ?>
                        ><?= $pasien['nama']?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            <div class="mb-3">
                ...
                <select class="form-select" name="id_dokter" id="id_dokter">
                    ...
                    <?php foreach($dokters as $dokter): ?>
                        ...
                        <?php if($kunjungan['id_dokter'] == $dokter['id']) echo 'selected' ?>
                        ><?= $dokter['nama'] ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
                ...
                <select class="form-select" name="id_poli" id="id_poli">
                    ...
                    <?php foreach($polis as $poli): ?>
                        <option value="<?= $poli['id'] ?>"
                            <?php if($kunjungan['id_poli'] == $poli['id']) echo 'selected' ?>
                        ><?= $poli['nama'] ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
